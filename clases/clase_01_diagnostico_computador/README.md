...
- Diferenciar CPU, memoria, almacenamiento y dispositivos.
- Explicar qué ocurre al ejecutar un programa.
- Identificar experiencias previas sin convertirlas en prerrequisito oculto.

## Preparación

Verificar que todos puedan iniciar sesión en Linux y abrir una terminal. Imprimir
el diagnóstico. No calificarlo.

## Secuencia

| Minutos | Actividad |
|---:|---|
| 0–15 | Presentación del curso, evaluación y reglas de trabajo |
| 15–35 | Diagnóstico individual: dibujar el recorrido de un programa |
